...
def main():
        ...
        for k in n_centroids:
            ...
            for file in os.listdir(pathname):
                if os.path.join(pathname, file).endswith('.csv'):
                    ...
                    simulation.append(Metrics.inter_cluster_statistic(centroids))
    ...
    for idx_alg in range(len(algorithms)):
        ...
        plt.title(algorithms[idx_alg] + ' - INTER CLUSTER DISTANCE')
        ...
        plt.tight_layout()
        plt.savefig(pathname_out + algorithms[idx_alg] + "-INTER.pdf")
