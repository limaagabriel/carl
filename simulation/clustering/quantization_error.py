...
def main():
    df = pd.read_csv('/home/elliackin/Documents/'
                     ...
                     '2017_LA-CCI_ClusteringSimulation-ID-10-Jun-2017-15h:01m:27s/data/quantization_error.csv')
    ...
    for algo in algos:
        ...
        plt.title(algo['ALGORITHM'].values[0] + ' - Quantization Error')
        ...
        plt.tight_layout()
        plt.savefig(pathname_out + algo['ALGORITHM'].values[0] + "-QE.pdf")
        i = i + 1
