...
def main():
    ...
    dfs[0] = pd.read_csv('data/iris.csv', header=None)
    # wine pd.read_csv('https://archive.ics.uci.edu/ml/machine-learning-databases/wine/wine.data', header=None)
    dfs[1] = pd.read_csv('data/wine.csv', header=None)
    # glass pd.read_csv('https://archive.ics.uci.edu/ml/machine-learning-databases/glass/glass.data', header=None)
    dfs[2] = pd.read_csv('data/glass.csv', header=None)
    ...
    dfs[13] = df = pd.read_csv('data/balance-scale.csv', header=None)
    # sonar
    dfs[14] = df = pd.read_csv('data/sonar.csv', header=None)
    # zoo pd.read_csv('http://archive.ics.uci.edu/ml/machine-learning-databases/zoo/zoo.data', header=None)
    dfs[15] = df = pd.read_csv('data/zoo.csv', header=None)
    # isolet5
    dfs[16] = df = pd.read_csv('data/isolet5.csv', header=None)
    # movement libras
    dfs[17] = df = pd.read_csv('data/libras.csv', header=None)
    # cleveland http://archive.ics.uci.edu/ml/machine-learning-databases/heart-disease/processed.cleveland.data
    dfs[18] = df = pd.read_csv('data/cleveland.csv', header=None)
    # australian
    dfs[19] = df = pd.read_csv('data/australian.csv', header=None)
    ...
    for eachdataset in range(0, 1):
        ...
        for i in range(len(name)):
            ...
            rng = range(2, 10)
            # 26
            for metricNumber in range(1, 27):
                for k in rng:
