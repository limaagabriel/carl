...
class PSOC_SearchSpaceInitializer(SearchSpaceInitializer):
    def __init__(self, n_clusters, dataset):
        super(PSOC_SearchSpaceInitializer, self).__init__()
...
class PSOCObjectiveFunction(ObjectiveFunction):
    def __init__(self, data, n_clusters, n_attributes):
        super(PSOCObjectiveFunction, self).__init__('PSOC', (n_clusters * n_attributes), 0.0, 1.0)
        self.n_clusters = n_clusters
